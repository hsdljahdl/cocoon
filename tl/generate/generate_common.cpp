...
int main() {
  generate_cpp("auto/tl", "cocoon_api", "std::string", "td::BufferSlice", "std::string", "td::BufferSlice",
               {"\"tl/tl/tl_object_parse.h\"", "\"tl/tl/tl_object_store.h\"", "\"td/utils/int_types.h\""},
               {"<string>", "\"td/utils/buffer.h\"", "\"td/utils/UInt.h\""});

  td::gen_json_converter(td::tl::read_tl_config_from_file("scheme/cocoon_api.tlo"), "auto/tl/cocoon_api_json",
                         "cocoon_api", td::tl::TL_writer::Mode::All);
}
