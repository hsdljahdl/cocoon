...
std::string TD_TL_writer_cpp::gen_fetch_class_name(const tl::tl_tree_type *tree_type) const {
  ...
  if (name == "#" || name == "Int32") {
    return "ton::TlFetchInt";
  }
  if (name == "Int53" || name == "Int64") {
    return "ton::TlFetchLong";
  }
  if (name == "True" || name == "Bool" || name == "Int" || name == "Long" || name == "Double" || name == "Int128" ||
      name == "Int256") {
    return "ton::TlFetch" + name;
  }
  if (name == "String" || name == "SecureString") {
    return "ton::TlFetchString<" + string_type + ">";
  }
  if (name == "Bytes" || name == "SecureBytes") {
    return "ton::TlFetchBytes<" + bytes_type + ">";
  }
  if (name == "Object") {
    return "ton::TlFetchObject<" + gen_base_type_class_name(0) + ">";
  }
  if (name == "Function") {
    return "ton::TlFetchObject<" + gen_base_function_class_name() + ">";
  }
  ...
  if (name == "Vector") {
    ...
    return "ton::TlFetchVector<" + gen_full_fetch_class_name(child) + ">";
  }
  ...
  return "ton::TlFetchObject<" + gen_main_class_name(t) + ">";
}
...
std::string TD_TL_writer_cpp::gen_full_fetch_class_name(const tl::tl_tree_type *tree_type) const {
  ...
  return "ton::TlFetchBoxed<" + gen_fetch_class_name(tree_type) + ", " + int_to_string(expected_constructor_id) + ">";
}
...
std::string TD_TL_writer_cpp::gen_store_class_name(const tl::tl_tree_type *tree_type) const {
  ...
  if (name == "#" || name == "Int" || name == "Long" || name == "Int32" || name == "Int53" || name == "Int64" ||
    ...
    return "ton::TlStoreBinary";
  }
  if (name == "Bool") {
    return "ton::TlStoreBool";
  }
  if (name == "True") {
    return "ton::TlStoreTrue";
  }
  if (name == "String" || name == "Bytes" || name == "SecureString" || name == "SecureBytes") {
    return "ton::TlStoreString";
  }
  if (name == "Object" || name == "Function") {
    return "ton::TlStoreObject";
  }
  ...
  if (name == "Vector") {
    ...
    return "ton::TlStoreVector<" + gen_full_store_class_name(child) + ">";
  }
...
std::string TD_TL_writer_cpp::gen_full_store_class_name(const tl::tl_tree_type *tree_type) const {
  ...
  if (is_built_in_complex_type(t->name)) {
    return "ton::TlStoreBoxed<" + gen_store_class_name(tree_type) + ", " + int_to_string(t->constructors[0]->id) + ">";
  }

  if (!is_type_bare(t)) {
    return "ton::TlStoreBoxedUnknown<" + gen_store_class_name(tree_type) + ">";
  }

  for (std::size_t i = 0; i < t->constructors_num; i++) {
    if (is_combinator_supported(t->constructors[i])) {
      return "ton::TlStoreBoxed<" + gen_store_class_name(tree_type) + ", " + int_to_string(t->constructors[i]->id) +
             ">";
    }
  }
